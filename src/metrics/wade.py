...
from src.metrics.ade import compute_ade
...
class WADE(Metric):
    ...
    def __init__(self,
        ...
        super(WADE, self).__init__(compute_on_step=compute_on_step, dist_sync_on_step=dist_sync_on_step,
    ...
    def update(self,
        ...
        wade = torch.mul(ade, weights)
        self.sum += wade.sum(dim=-1).sum()
